...
class TestModel {
  static WorkPlaces workPlaces = WorkPlaces(idUser: '', listWorkPlace: [
    WorkPlace(nameWorkPlace: 'nameWorkPlace1',
        ...
        works: Works(idUser: '',idWorkPlace: '',listWork: [
          Work(positionPersonPlace: 'positionPersonPlace1', skillsPersonPlace: 'skillsPersonPlace1', levelPersonPlace: 'levelPersonPlace1', startDate: DateTime.utc(2020), endDate: DateTime.utc(2021),endDateForNow: true)
          ,Work(positionPersonPlace: 'positionPersonPlace2', skillsPersonPlace: 'skillsPersonPlace2', levelPersonPlace: 'levelPersonPlace2', startDate: DateTime.utc(2020), endDate: DateTime.utc(1))
        ]),
        startDate: DateTime.utc(2020),
        endDate: DateTime.utc(2021),
    endDateForNow: true),
    WorkPlace(nameWorkPlace: 'nameWorkPlace2',
  ...
  CvUser cvUser1 = CvUser(
      personalInformation: PersonalInformation(name: 'name1',
      ...
      projects: Projects(idUser: '', listProject: [
        Project(nameProject: 'nameProject1',
